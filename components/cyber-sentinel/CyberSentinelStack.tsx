...
export function CyberSentinelStack() {
  return (
    <section id="stack" className="py-16 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {cyberSentinelData.techStack.map((tier) => (
            <GlassPanel key={tier.category} variant="default" className="p-6 hover:border-red-400/30 transition-all">
              <div className="flex items-center gap-2 mb-3 font-mono text-xs font-bold text-red-300">
